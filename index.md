...
This document is a draft NIST specification on a common data format (CDF) for voter records interchange (VRI). It contains a brief introduction and a description of the UML model/XML schema.  Future sections will cover the use cases and contain additional detail.  
